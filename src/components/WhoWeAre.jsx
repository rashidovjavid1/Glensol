        ...
        <div className="whoWeAreMain">
          <div className="whoWeAreLeft">
            ...
            <div className="aboutUs">
              <p>
                Glensol, a subsidiary of Nobel Energy Group, has been a trusted
                services provider in the Oil & Gas, Power and Water industries
                since 2012. Glensol offers a comprehensive range of services
                that optimize the performance and reliability of critical
                assets.
              </p>
            </div>
